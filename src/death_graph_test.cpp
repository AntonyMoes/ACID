...
#include <test_death_system.h>
#include <test_toggle_death_system.h>
  ...
  public:
    void execute() override {
        ...
        if (i < 1) {
            ...
            entity->add_component(death_component);
...
int main() {
    ...
    auto* test_death_system = new TestDeathSystem;
    gameloop.add_system(test_death_system);
    gameloop.register_life_system(test_death_system);
    auto* test_toggle_death_system = new TestToggleDeathSystem;
    gameloop.add_system(test_toggle_death_system);
    auto* death_node = new TestDeathNode;
    gameloop.add_prototype(death_node);
